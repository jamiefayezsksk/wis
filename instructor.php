    ...
    <div class="card-style">
        ...
        <table style="width:40%">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <tr>
                    <td></td>
                    <td><input type="submit" value="submit" name="addinstructor"></td>
                </tr>
            </form>
        </table>
    </div>
            ...
            if ($result->num_rows > 0) {
                ...
                <table style="width:40%">
                    <form method="POST" action="Instructor_Record.php">
                        ...
                        <tr>
                            <td>First Name:</td>
                            <td><input type="text" name="ifirstname" value="<?php echo $editstudent['FirstName']; ?>"></td>
                        </tr>
                        <tr>
                            <td>Last Name:</td>
                            <td><input type="text" name="ilastname" value="<?php echo $editstudent['LastName']; ?>"></td>
                        </tr>
                        <tr>
                            <td>Email:</td>
                            <td><input type="text" name="iemail" value="<?php echo $editstudent['Email']; ?>"></td>
                        </tr>
                        <tr>
                            <td>Phone: </td>
                            <td><input type="text" name="iphone" value="<?php echo $editstudent['Phone']; ?>"></td>
                        </tr>
                        <tr>
                            <td></td>
